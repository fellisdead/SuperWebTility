    ...
    <div className="flex flex-col items-center">
      <main className="w-full max-w-[1200px] px-4 flex flex-col mt-16 mb-24">
        <div className="mb-8 text-center md:text-left">
          <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-4 gradient-text pb-2">Video Editor</h1>
          <p className="text-lg text-gray-600 dark:text-slate-400 font-medium">
            Layer images over video, add audio tracks, trim clips — all processed locally in your browser.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8">
          ...
          <div className="space-y-4">
            ...
            >
              <ImageTools images={images} setImages={setImages} />
            </AccordionCard>
            ...
            >
              <AudioTools audioTracks={audioTracks} setAudioTracks={setAudioTracks} />
            </AccordionCard>
          </div>
        </div>
      </main>
